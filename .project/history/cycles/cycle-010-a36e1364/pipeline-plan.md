...
description: "Quatro slices coordenadas em UM PR: (1) split arquitetural + Field portado; (2) TModernRTTIMethod/Parameter e backends com vmtMethodTable; (3) cirurgia do Fail em UScenarios.RTTI.pas (Closes #35); (4) fixtures e published tests com prova de mutação."
status: stable
cycle: "010"
agent: architect
